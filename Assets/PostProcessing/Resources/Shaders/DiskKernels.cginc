...
static const float2 kDiskKernel[kSampleCount] = {
    ...
    float2(-0.11857785,0.5199616),
    float2(-0.48051673,0.2314047),
    float2(-0.48051673,-0.23140468),
    float2(-0.11857763,-0.51996166),
...
static const float2 kDiskKernel[kSampleCount] = {
    ...
    float2(0.42510567,0.5330669),
    float2(0.15171895,0.6647236),
    float2(-0.15171893,0.6647236),
    float2(-0.4251058,0.53306687),
    float2(-0.614297,0.29582986),
    float2(-0.6818182,0),
    float2(-0.614297,-0.29582983),
    float2(-0.42510556,-0.53306705),
    float2(-0.15171856,-0.66472363),
    float2(0.1517192,-0.6647235),
    float2(0.4251056,-0.53306705),
    float2(0.614297,-0.29582983),
    float2(1,0),
